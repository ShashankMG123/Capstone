...
//		System.out.println("Inside  sample spout code");
		this.csvFileName = "/home/riot-bench/modules/tasks/src/main/resources/SYS_sample_data_senml.csv";
...
//		}
	...
	public void open(Map map, TopologyContext context, SpoutOutputCollector collector) {
		...
		try {
			...
			if(InetAddress.getLocalHost().getHostName().compareTo("ip-172-31-46-109")==0)
